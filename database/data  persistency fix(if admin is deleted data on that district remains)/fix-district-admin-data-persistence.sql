...
SET @sql = IF(@constraint_name IS NULL,
  'ALTER TABLE news ADD CONSTRAINT fk_news_owner FOREIGN KEY (owner_admin_id) REFERENCES district_admins(id) ON DELETE SET NULL',
...
SET @sql = IF(@constraint_name IS NULL,
  'ALTER TABLE events ADD CONSTRAINT fk_events_owner FOREIGN KEY (owner_admin_id) REFERENCES district_admins(id) ON DELETE SET NULL',
  'SELECT "Foreign key constraint already exists" as message'
);
...
SET @sql = IF(@constraint_name IS NULL,
  'ALTER TABLE products ADD CONSTRAINT fk_products_owner FOREIGN KEY (owner_admin_id) REFERENCES district_admins(id) ON DELETE SET NULL',
  'SELECT "Foreign key constraint already exists" as message'
);
...
SET @sql = IF(@constraint_name IS NULL,
  'ALTER TABLE photo_events ADD CONSTRAINT fk_photo_events_owner FOREIGN KEY (owner_admin_id) REFERENCES district_admins(id) ON DELETE SET NULL',
  'SELECT "Foreign key constraint already exists" as message'
);
...
SET @sql = IF(@constraint_name IS NULL,
  'ALTER TABLE photo_galleries ADD CONSTRAINT fk_photo_galleries_owner FOREIGN KEY (owner_admin_id) REFERENCES district_admins(id) ON DELETE SET NULL',
  'SELECT "Foreign key constraint already exists" as message'
);
...
SET @sql = IF(@constraint_name IS NULL,
  'ALTER TABLE photos ADD CONSTRAINT fk_photos_owner FOREIGN KEY (owner_admin_id) REFERENCES district_admins(id) ON DELETE SET NULL',
  'SELECT "Foreign key constraint already exists" as message'
);
...
-- Clean up orphaned references first (if table exists)
-- Must do this BEFORE adding the constraint
...
-- First ensure column is nullable (separate step)
SET @sql = IF(@table_exists > 0,
