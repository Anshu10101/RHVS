        ...
        <div className="container mx-auto px-4">
          ...
          {posts.length === 0 ? (
            <div className="max-w-2xl mx-auto text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-slate-700 mb-2">No Posts Created</h3>
              <p className="text-slate-600">Posts have not been created for this department yet.</p>
            </div>
          ) : (
