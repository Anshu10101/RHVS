      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {departments.map((department) => (
            <Card
              key={department.id}
              className="group relative overflow-hidden border border-slate-200/70 bg-white/90 backdrop-blur-sm shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-orange-200/70 rounded-3xl h-[390px]"
            >
              ...
              <div className="relative h-[72%]">
                ...
                {/* Image overlay with department names */}
                <div className="absolute inset-x-0 bottom-0 p-4">
                  <div className="rounded-2xl px-3 py-2 bg-gradient-to-t from-black/80 via-black/50 to-transparent backdrop-blur-[2px]">
                    <h3 className="text-white text-[22px] font-extrabold tracking-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.45)] line-clamp-1">
                      {department.name_hi}
                    </h3>
                    <p className="text-white/90 text-[13px] leading-tight font-medium line-clamp-1">
                      {department.name_en}
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="px-4 pt-2 pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-orange-400/70 group-hover:text-orange-500 transition-colors" aria-hidden>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M5 12h14M13 5l7 7-7 7"/></svg>
                  </div>
                </div>
              </CardContent>
            </Card>
